...
version 42
__lua__
-- memory match - flip tiles to find matching pairs
-- test infrastructure
testmode = false
test_log = {}
test_inputs = {}
...
function update_menu()
  if test_input(2) then  -- right
    menu_selected = (menu_selected + 1) % menu_options
  end
...
00110000185401854018540175401754017340173401724017240172401634016340163400000000000000000000000000000000000000000000000000000
__music__
000100000402040304020403040204030402040304020403040204030402040304020403040204030402040304020403000000000000000000000000000000
